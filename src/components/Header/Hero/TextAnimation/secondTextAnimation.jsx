...
import css from "./secondaryTextAnimation.module.scss";

function SecondaryTextAnimation() {
  const texts = ["I am a Web Developer. I love design beautiful things and I love what I did"];
...
export default SecondaryTextAnimation;
